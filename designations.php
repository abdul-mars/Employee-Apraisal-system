		...
		<div class="project-page d-flex justify-content-between align-items-center flex-wrap">
			<div class="project mb-4">
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-bs-toggle="tab" href="#AllStatus" role="tab">Designations</a>
					</li>
					<li>
						<?php if (@$_GET['msg']) {
						if (@$_GET['cssClass']) { ?>
			...
			<div class="mb-4">
				...
				<button class="btn btn-outline-primary btn-rounded fs-18"  data-bs-toggle="modal" data-bs-target="#newDesgnationModal"><i class="fas fa-plus"></i> New Designation</button>
			</div>

			<!-- add new designation Modal start -->
			<div class="modal fade" id="newDesgnationModal" data-bs-backdrop="static">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<form action="operations.php?operation=add_designation" method="post">
							<div class="modal-body">
								<div class="form-group">
									<div class="row">
										<label for="designation" class="form-label mt-2">Designation Name</label>
										<input type="text" name="designation" id="designation" class="form-control border border-primary border-2">
										<label for="desc" class="form-label mt-2">Designation Description</label>
							...
							<div class="modal-footer">
								...
								<button type="submit" name="addDesigSubmit" class="btn btn-primary">Submit</button>
							</div>
						</form>
					</div>
				</div>
											...
											<?php $sql = mysqli_query($con, "SELECT * FROM `designation_list`");
												...
												while ($data = mysqli_fetch_assoc($sql)) { ?>
													<tr>
														...
														<td>
															<span>
																<button class="btn btn-outline-primary p-2 m-1" data-bs-toggle="modal" data-bs-target="#updateDesigModal<?= $data['id']; ?>">
																	<i class="far fa-edit "></i>
																</button>
													...
													<!-- update Modal start -->
													<div class="modal fade" id="updateDesigModal<?= $data['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
														<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
															<div class="modal-content">
																...
																<form action="operations.php?operation=update_designation" method="post">
																	<div class="modal-body">
																		<div class="form-group">
																			<div class="row">
																				<input type="hidden" name="designId" value="<?= $data['id']; ?>">
																				<label for="designation" class="form-label mt-2">Designation Name</label>
																				<input type="text" name="designation" id="designation" value="<?= $data['designation']; ?>" class="form-control border border-primary border-2">
																				<label for="desc" class="form-label mt-2">Designation Description</label>
																				<!-- <input type="text" name="desc" id="desc" class="form-control border border-primary border-2"> -->
																	...
																	<div class="modal-footer">
																		...
																		<button type="submit" name="updateDesignSubmit" class="btn btn-primary">Update</button>
																	</div>
																</form>
															</div>
														</div>
													...
													<div class="modal fade" id="delDepModal<?= $data['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
														<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
															<div class="modal-content">
																...
																<form method="post" action="operations.php?operation=delete_designation">
																	<div class="modal-body">
																		<div class="row">
																	...
																	<div class="modal-footer">
																		...
																		<button type="submit" name="designSubmit" class="btn btn-danger">Yes, Delete</button>
																	</div>
																</form>
															</div>
														</div>

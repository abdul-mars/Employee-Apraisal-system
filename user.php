...
<html lang="en" class="h-100">
    ...
    <body class="vh-100">
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        ...
                                        <h4 class="text-center mb-4 h2">Sign in your account</h4>
                                        <h6 class="text-danger text-center fw-bold error"></h6>
                                        <!-- <form action="operations.php?operation=user_login" method="post"> -->
                                            <div class="mb-3">
                                            ...
                                            <div class="row d-flex justify-content-between mt-4 mb-2">
                                                ...
                                                <div class="mb-3">
                                                    <a href="operations.php?operation=user_forgot_password">Forgot Password?</a>
                                                </div>
                                            </div>
                                            <div class="text-center">
                                                <button type="button" name="userLoginSubmit" id="userLoginSubmit" class="btn btn-primary btn-block">Sign Me In</button>
                                            </div>
                                        </form>
        ...
        ***********************************-->
        <!-- Required vendors -->
        <script src="js/code.jquery.com-jquery-3.6.0.js"></script>

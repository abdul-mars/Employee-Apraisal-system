                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form action="operations.php?operation=user_first_time" method="post" class="needs-validation" enctype="multipart/form-data">
                                            <div class="row">
                                            ...
                                            <button class="btn btn-primary" name="userFirstTimeSubmit">Submit</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
